# SPEC-40 — Studio Information, Contact & Legal

## Objective

- Implement public studio information required by the business.
...
- Expose studio address, phone, working hours, social links, licenses, Enamad metadata and legal documents.
- Make values admin-configurable.

## Frontend Scope

- Create About, Contact, Location, Working Hours, Certificates, Terms, Privacy, Booking Policy, Cancellation, Printing and Delivery screens.
...
- [ ] Information is accessible without cluttering initial home viewport.
- [ ] External links are safe and validated.
