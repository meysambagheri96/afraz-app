# SPEC-37 — Notifications Backend

## Objective

- Implement in-app notification model and delivery integration foundation.
...
- Create Notification entity/read state.
- Add notification service abstraction.
- Add FCM/SMS adapters and Hangfire jobs.
- Support appointment reminders and order/payment events.
...
- [ ] Failures can be retried where appropriate.
