# SPEC-18 — Booking Management

## Objective

- Allow customers to view/manage their reservations.
...
- Implement list/detail, cancel, reschedule policies and status history.
- Authorization must enforce ownership.

## Frontend Scope

- Create Upcoming, Completed, Cancelled tabs and reservation detail.
- Add cancel/reschedule flows based on backend policy.
...
- [ ] UI communicates policy restrictions.
