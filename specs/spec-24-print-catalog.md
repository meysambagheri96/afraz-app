# SPEC-24 — Print Sizes & Pricing

## Objective

- Implement configurable print sizes and pricing.
...
- Create PrintSize configuration with dimensions, price, active flag and optional metadata.
- Expose active options.

## Frontend Scope

- Create size/quantity selector components.
...
- [ ] Inactive sizes cannot be ordered.
- [ ] Price always comes from backend.
