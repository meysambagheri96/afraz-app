# SPEC-29 — Album Preview

## Objective

- Provide a visual preview representation before purchase.
...
- Provide preview data contract and optional generated preview job hooks.
- Do not block normal requests on heavy rendering.

## Frontend Scope

- Create page-turning/preview UI using selected photos and configuration.
- Clearly label preview vs final production output if approximate.
...
- [ ] Preview is performant.
- [ ] Heavy generation can run in background.
- [ ] Selected photos remain authorized.
