# SPEC-56 — Production Readiness & Release
...
- Environment separation, production configuration, DB migration plan, backup/restore strategy, Redis/object-storage configuration, payment/SMS/FCM production credentials, monitoring.

## Frontend Scope

- Capacitor production builds, icons/splash, safe-area/device validation, offline/error/session behavior review.
