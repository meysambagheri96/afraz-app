# SPEC-35 — Store Order & Payment

## Objective

- Create final store order from validated cart and checkout data.
...
- Validate inventory/availability, prices, shipping and totals in transaction.
- Create order then connect to payment subsystem.
- Prevent duplicate submissions.

## Frontend Scope

- Review → payment → success/failure.
...
- [ ] Duplicate client retries do not create duplicate paid orders.
- [ ] Order contains snapshot of purchased product/variant data where needed.
