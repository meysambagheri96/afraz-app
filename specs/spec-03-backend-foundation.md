...
- Create base application pipeline.
...
- Create request correlation/logging behavior if useful.
- Create DbContext base.
- Create feature folder convention and example no-op/smoke slice.
