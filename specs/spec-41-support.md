# SPEC-41 — FAQ & Customer Support

## Objective

- Implement support experience.
...
- Create FAQ read API and SupportTicket/SupportTicketMessage model.
- Enforce customer ownership.
- Support statuses.

## Frontend Scope

- FAQ, contact options, create ticket, ticket list/detail.
