# SPEC-48 — Image Processing Pipeline

## Objective

- Create scalable processing for uploaded photography assets.
...
- Use background jobs for thumbnails/medium/high variants.
- Store metadata in SQL Server and files in object storage.
- Make processing idempotent/retryable.
- Optional watermarking policy hooks.
...
- [ ] Frontend uses optimized derivatives.
- [ ] No long image work blocks API request.
