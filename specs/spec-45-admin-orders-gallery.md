# SPEC-45 — Admin Orders & Gallery Management

## Objective

- Allow studio staff to manage photography orders and upload/publish customer galleries.
...
- Upload gallery metadata/files through secure object-storage pipeline.
- Generate thumbnails/background processing hooks.
- Publish gallery to correct customer order.

## Frontend Scope

- Admin order/galleries workflow.
...
- [ ] Gallery cannot be attached to wrong customer/order accidentally.
- [ ] Uploads are validated by type/size.
