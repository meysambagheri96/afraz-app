# SPEC-27 — Album Configuration Catalog

## Objective

- Implement configurable physical album options.
...
- Create AlbumType, AlbumSize, AlbumMaterial, AlbumColor, page-count/pricing rules.
- Expose only valid active combinations.

## Frontend Scope

- Create reusable album option selectors.
...
- [ ] Backend can validate allowed combinations.
- [ ] Prices/options are admin-configurable.
