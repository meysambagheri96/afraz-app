# SPEC-44 — Admin Portfolio & Booking Management

## Objective

- Allow admins to manage portfolio, services, packages and booking availability.
...
- CRUD/publish/order featured portfolio.
- Manage services/packages.
- Manage working calendar, closed dates, time slots.
- View/cancel/reschedule bookings.

## Frontend Scope

- Admin screens for these workflows.
...
- [ ] Changes immediately affect customer read models as expected.
- [ ] Audit important booking changes.
