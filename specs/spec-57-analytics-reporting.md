# SPEC-57 — Analytics & Business Reporting Foundation

## Objective

- Provide privacy-conscious product/business analytics needed by the studio.
...
- Define events for bookings, payments, gallery selection, print/album/store conversion.
- Create operational reporting queries for bookings/orders/payments without introducing a separate analytics platform prematurely.

## Frontend Scope

- Add client analytics abstraction if enabled.
- Do not block UX on analytics delivery.
...
- [ ] Analytics failures never break business flows.
- [ ] Personally sensitive information is minimized.
