# SPEC-46 — Admin Printing, Albums & Store

## Objective

- Allow configuration and operational management of print, album and store domains.
...
- Manage print sizes/prices.
- Manage album options/pricing.
- Manage products/categories/variants/stock.
- Manage production/order statuses.

## Frontend Scope

- Admin screens for configuration and fulfillment.
...
- [ ] Price/config changes are validated.
- [ ] Historic orders preserve purchased values as needed.
