# SPEC-14 — Public Portfolio Frontend

## Objective

- Implement public photography browsing.
...
- Category pages for newborn, child, birthday, pregnancy, family, outdoor.
- Gallery grid and fullscreen viewer.
...
- [ ] Photography is visually dominant.
- [ ] Navigation and swipe behavior are RTL-correct.
- [ ] Large galleries remain performant.
