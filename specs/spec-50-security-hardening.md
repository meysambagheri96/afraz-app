# SPEC-50 — Security Hardening

## Objective

- Apply production security controls across API, WebView and storage.
...
- HTTPS, CORS, rate limiting, secure headers, auth policies, upload validation, secret management, token handling, signed asset access, payment verification.
- Review logs for sensitive data.

## Frontend Scope

- Ensure frontend does not embed secrets.
...
- [ ] Private assets and admin APIs are protected.
