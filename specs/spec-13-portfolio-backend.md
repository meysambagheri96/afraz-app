# SPEC-13 — Public Portfolio Backend

## Objective

- Implement portfolio categories and public portfolio query model.
...
- Create PortfolioCategory and PortfolioItem entities/configurations.
- Implement featured flag, publish status and ordering.
- Add pagination/category filtering endpoints.
...
- [ ] Featured ordering is deterministic.
