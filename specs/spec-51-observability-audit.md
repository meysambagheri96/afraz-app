# SPEC-51 — Observability, Audit & Status Histories

## Objective

- Make critical workflows diagnosable and auditable.
...
- Health checks.
- Status histories for booking/orders/print/album/store.
- Payment audit logs.
- Admin audit for critical actions.
...
- [ ] A failed payment/order can be traced.
- [ ] Logs do not contain secrets.
- [ ] Health endpoints are deployable.
