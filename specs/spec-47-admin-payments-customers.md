# SPEC-47 — Admin Payments & Customer Operations

## Objective

- Provide safe operational visibility into customers and payments.
...
- Customer lookup, reservation/order history, payment transaction search, failure visibility, reconciliation support, refund hook if business enables it.
- Audit sensitive admin actions.

## Frontend Scope

- Admin customer/payment views.
...
- [ ] Manual state changes are controlled and auditable.
