# SPEC-42 — Unified Public Search

## Objective

- Implement search for public portfolio and store content.
...
- Create bounded search APIs for public content.
- Do not expose private gallery/order data to global search.

## Frontend Scope

- Search UI with recent query/empty/no-result/loading states.
...
- [ ] Private resources never appear.
- [ ] Results are paginated and categorized.
