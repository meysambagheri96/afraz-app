# SPEC-22 — Private Gallery Backend

## Objective

- Implement secure customer galleries.
...
- Create Gallery and GalleryPhoto metadata.
- Enforce order/customer ownership.
- Provide paginated thumbnail/medium URLs, signed/protected access where required.
- Support favorites.
...
- [ ] IDs alone never grant access.
- [ ] Gallery APIs are paginated.
- [ ] Original files are not returned by default.
