# SPEC-15 — Photography Services & Packages

## Objective

- Implement studio services and packages as configurable backend data.
...
- Create PhotographyService and PhotographyPackage.
- Support duration, edited photo count, decor/setup count, total price, deposit, active status.
- Expose read APIs for booking flow.

## Frontend Scope

- Create reusable service/package cards for booking.
...
- [ ] Inactive packages cannot be booked.
- [ ] Prices originate from backend.
- [ ] UI clearly shows package differences.
