# SPEC-55 — CI/CD Pipeline

## Objective

- Create repeatable build, test and release automation.
...
- Pipeline runs restore/build/tests, frontend build, release publish, migrations strategy, health verification.

## Frontend Scope

- Frontend type-check/lint/test/build in CI.
...
- [ ] Release artifact contains Vue in wwwroot.
- [ ] Failed tests block deployment.
- [ ] Secrets are provided by CI secret store.
