# SPEC-54 — Performance & Image-Heavy UX Optimization

## Objective

- Optimize the app after functional flows exist.
...
- Index slow SQL queries.
- Project DTOs, paginate, cache stable public data.
- Review Redis use based on measurements.

## Frontend Scope

- Lazy images, responsive sources, route splitting, gallery virtualization where necessary, bundle analysis.
...
- [ ] No unbounded large API responses.
- [ ] Core screens perform acceptably on mobile network/device conditions.
