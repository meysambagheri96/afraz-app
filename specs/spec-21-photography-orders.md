# SPEC-21 — Photography Orders

## Objective

- Create the post-session photography order model.
...
- Implement order entity/status history and customer list/detail queries.
- Connect order to booking where relevant.

## Frontend Scope

- Create Orders list and Order Details.
- Expose actions based on state: view gallery, print, create album, pay balance.
...
- [ ] Action availability matches backend state.
