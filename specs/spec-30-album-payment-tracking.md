# SPEC-30 — Album Payment & Production Tracking

## Objective

- Connect album order to payment and production statuses.
...
- Use payment subsystem and status history.
- Support paid, design/production, ready, delivered states.

## Frontend Scope

- Payment result and album tracking screens.
...
- [ ] Successful verified payment starts eligible production workflow.
