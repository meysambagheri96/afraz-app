# SPEC-33 — Shopping Cart

## Objective

- Implement customer shopping cart.
...
- Create server-backed or clearly defined persistent cart model.
- Validate product/variant availability.
- Recalculate prices server-side.

## Frontend Scope

- Cart list, quantity controls, remove, summary, optional coupon placeholder if business enables it.
...
- [ ] Frontend totals are informational.
- [ ] Backend recalculates before checkout.
