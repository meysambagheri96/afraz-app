# SPEC-31 — Online Store Catalog Backend

## Objective

- Implement ready-made photography products and categories.
...
- Create ProductCategory, Product, ProductImage, ProductVariant, active status, prices and optional stock.
- Add listing/search/detail APIs with pagination.
...
- [ ] Product prices/variants are backend-controlled.
- [ ] Queries are bounded.
