# SPEC-38 — Notifications Frontend
...
- Notification badge in header/nav where approved.
- List, unread/read states, empty state, detail/navigation actions.
- Handle deep links into booking/order/gallery/payment screens.
...
- [ ] Tap action navigates to correct business context.
