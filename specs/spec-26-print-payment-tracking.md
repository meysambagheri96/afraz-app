# SPEC-26 — Print Payment & Tracking

## Objective

- Connect print orders to payment and status tracking.
...
- Use core payment subsystem.
- Support statuses: awaiting payment, paid, production, ready, shipped/pickup, delivered, cancelled.

## Frontend Scope

- Implement payment result and print tracking UI.
...
- [ ] Verified payment transitions print order correctly.
- [ ] Status changes appear to customer.
