# SPEC-43 — Administration Foundation

## Objective

- Create secure administrative backend/UI foundation for business operations.
...
- Add admin roles/policies and audit foundation.
- Create admin layout/API boundaries without exposing customer-only routes.

## Frontend Scope

- Create admin shell/navigation if admin UI is in same Vue app; otherwise prepare clearly separated admin route area.
...
- [ ] Admin actions can be audited where critical.
