# SPEC-36 — Remaining Photography Balance

## Objective

- Allow customer to pay outstanding photography balance.
...
- Expose backend-calculated total/paid/remaining amounts.
- Create payment request against specific order/booking balance.
- Prevent overpayment.

## Frontend Scope

- Create balance detail and payment CTA/result.
