# SPEC-58 — Final UX Polish & Accessibility Review

## Objective

- Perform a cross-feature consistency pass before final release.
...
- Verify typography scale, icon scale, section spacing, Liquid Glass nav, SVG backgrounds, RTL, Persian copy, skeleton/empty/error states, accessibility labels, contrast, reduced motion, touch sizes and iPhone 17 Pro Max layout.
...
- [ ] No screen uses accidental legacy styling.
