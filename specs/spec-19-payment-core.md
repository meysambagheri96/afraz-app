# SPEC-19 — Payment Infrastructure

## Objective

- Create a generic but business-safe payment subsystem used by booking, print, album, store and remaining balance flows.
...
- Create Payment/PaymentTransaction models.
- Implement create payment, callback verification, idempotency, reconciliation-ready status model.
- Abstract payment gateway adapter.
- Never trust client amount.

## Frontend Scope

- Create shared payment processing/result UI.
- Handle redirect/deep-link return.
...
- [ ] Successful payment requires backend verification.
- [ ] Payment audit trail exists.
