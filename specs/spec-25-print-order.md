# SPEC-25 — Photo Print Order

## Objective

- Allow customers to order physical prints from selected gallery photos.
...
- Implement CreatePrintOrder with ownership checks, size validation, quantity validation, server-side price calculation.
- Create status history.

## Frontend Scope

- Implement selected photos → configure size/quantity → cart/review flow.
...
- [ ] Invalid or foreign photos are rejected.
- [ ] UI allows edit/remove before checkout.
