...
- Implement favorites for public portfolio, store products and private gallery photos.
...
- Create appropriate scoped persistence and ownership rules.

## Frontend Scope

- Favorite/unfavorite actions and Favorites page/sections.
...
- [ ] Private gallery favorite never leaks across customers.
- [ ] Public/product favorites survive sessions for authenticated users.
