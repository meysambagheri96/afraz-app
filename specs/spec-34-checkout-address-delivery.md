# SPEC-34 — Checkout Address & Delivery

## Objective

- Implement checkout customer/address/delivery flow.
...
- Create customer addresses and delivery method validation.
- Support studio pickup and shipping.
- Calculate shipping server-side if applicable.

## Frontend Scope

- Address management, delivery selection, checkout review.
...
- [ ] Pickup does not require shipping-only data.
