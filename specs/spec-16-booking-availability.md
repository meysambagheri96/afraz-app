...
- Create studio working calendar/closed dates/slot configuration.
- Implement GetAvailableDates/GetAvailableSlots.
- Return available, unavailable and full states.

## Frontend Scope

- Implement Jalali calendar screen and time-slot selector.
- Handle loading, no availability, selected states.
