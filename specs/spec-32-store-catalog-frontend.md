...
- Implement premium photography-product shopping UI.
...
- Store home, categories, product list, search, product detail, image gallery, variants, favorites.
- Use photography-focused product presentation rather than generic enterprise cards.
...
- [ ] Loading/empty/search-no-result states exist.
