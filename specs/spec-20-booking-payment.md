# SPEC-20 — Booking Deposit & Full Payment

## Objective

- Connect booking to payment subsystem.
...
- Support deposit and full booking payment.
- Update booking payment state after verified callback.
- Calculate remaining balance.

## Frontend Scope

- Add payment choice and result screens.
...
- [ ] Booking shows correct paid/remaining amounts.
- [ ] Payment failure leaves booking in valid state.
