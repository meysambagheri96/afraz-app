# SPEC-11 — Home Aggregation API

## Objective

- Create a single optimized home query returning public and customer-context data needed by the Home screen.
...
- Return studio header data, featured portfolio, categories, album/store preview, upcoming booking/customer actionable context, notification count.
- Project directly to response DTOs.
- Cache public/stable parts where appropriate.
...
- [ ] Home request is bounded and optimized.
- [ ] Private customer data is returned only when authenticated.
- [ ] No N+1 behavior.
